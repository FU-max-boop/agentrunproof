...
- [x] (2026-08-21) Published v0.3.0 for SDK 0.22 compatibility: widened metadata to `<0.23`, added
  exact 0.22.0 packaged-wheel cells, and made the output-guardrail history check require linked
...
- **2026-08-21 — v0.3 SDK 0.22 compatibility:** Extend the declared window to
  ...
  signed-off evidence and historical lock files remain immutable. Until fresh clean-commit
  evidence and all release gates existed, documentation and workflow preparation could not imply
  that 0.3.0 had been published.
- **2026-08-21 — v0.3 evidence publication sequence:** Freeze all package inputs, final release
  metadata, release-profile logic, and evidence-generation workflow in one clean source commit C.
  Generate the versioned v3 comparison on canonical Linux from C, then add only the six JSON
  evidence members in a direct child commit E. The v0.3.0 tag must point directly to E; v1 and v2
  evidence remain immutable and continue to be checked. This preserves the two-commit provenance
  design and prevents a release artifact from claiming evidence generated by a different source.
- **2026-08-21 — v0.3.0 publication:** The release gate above was satisfied. Annotated tag v0.3.0
  points to evidence commit `6de31ca9653fc8287d0fecc42be2c70781f0dc33`; the GitHub Release is
