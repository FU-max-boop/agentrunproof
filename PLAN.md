...
- [x] (2026-08-21) Prepared the v0.3.0 source release candidate for SDK 0.22: widened metadata to
  ...
  full suite locally on CPython 3.12 against exact SDK 0.20.0, 0.21.0, and 0.22.0. The full hosted
  Python 3.10–3.14 matrix passed on the release-candidate PR and main; a fresh release-bound v3
  evidence bundle remains the publication gate.
